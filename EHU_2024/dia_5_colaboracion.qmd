...
!["FINAL.doc"](images/FINALdoc.png){alt="\"FINAL.doc\""}
...
![Página inicial de GitHub](images/github_pag_ini.JPG){alt="Página inicial de GitHub"}
...
![Terminal de Git](images/terminal-2.png){alt="Terminal de Git"}
...
![Lo que esperamos que hayáis aprendido](images/git-2.png){alt="Lo que esperamos que hayáis aprendido"}
...
![Graphical representation of the different working areas in Git and GitHub: working directory, staging area or Index, local repository or HEAD, and remote repository. Background image from Philip Brookes (<https://creativecommons.org/licenses/by-nc-nd/2.0/legalcode>)](images/arboles.jpg){alt="Graphical representation of the different working areas in Git and GitHub: working directory, staging area or Index, local repository or HEAD, and remote repository. Background image from Philip Brookes (https://creativecommons.org/licenses/by-nc-nd/2.0/legalcode)"}
...
![Flujo de trabajo en Git y GitHub mostrando las diferentes zonas de trabajo y los comandos utilizados para la transición de una zona de trabajo a otra.](images/workflow_git_github.jpg){alt="Flujo de trabajo en Git y GitHub mostrando las diferentes zonas de trabajo y los comandos utilizados para la transición de una zona de trabajo a otra."}
