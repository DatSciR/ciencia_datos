...
subtitle: "Visualización y análisis exploratorio de datos"
author: 
...
# ya que están muy sesgados al número de muestras. Además, también se
# permite cierta desviación de la normalidad en los residuos.
...
Haz un histograma y cambia el número de intervalos para ver como cambia la distribución de la variable.
...
La **colinealidad** es la existencia de correlación entre covariables de un modelo. Un ejemplo típico en ecología es la altitud con la precipitación o la temperatura. Si se ignora puede ocurrir que no haya nada significativo en el modelo o situaciones absurdas como que al quitar una covariable, el resto se hagan significativas. Aumentar el número de variables en el modelo hace que la R^2^ (coeficiente de determinación: cuanta de la variación de y es explicada por las covariables) aumente, pero también la colinealidad. A mayor R^2^, mayores errores estándar de de los parámetros haciendo que los p-valores significativos sean más difíciles de detectar.
